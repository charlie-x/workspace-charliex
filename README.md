# com-chilipeppr-workspace-charliex
Testing ChiliPeppr Workspace.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / charliex
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-charliex |
| Name                  | Workspace / charliex |
| Description           | Testing ChiliPeppr Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/charlie-x/workspace-charliex/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/charlie_x/workspace-charliex |
| Github URL            | http://github.com/charlie-x/workspace-charliex |
| Test URL              | https://preview.c9users.io/charlie_x/workspace-charliex/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/charlie-x/workspace-charliex/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-charliex"], // the id you gave your workspace
      function(myWorkspaceCharliex) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / charliex just got loaded.", myWorkspaceCharliex);
        myWorkspaceCharliex.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-charliex"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / charliex"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"Testing ChiliPeppr Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/charlie-x/workspace-charliex/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/charlie_x/workspace-charliex"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/charlie-x/workspace-charliex"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-charliex-charlie_x.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
